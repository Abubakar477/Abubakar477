...
<picture>
  <source media="(prefers-color-scheme: dark)"  srcset="assets/banner-dark.v9.svg?v=11">
  <source media="(prefers-color-scheme: light)" srcset="assets/banner-light.v9.svg?v=11">
  <img src="assets/banner-dark.v9.svg?v=11" width="100%" alt="profile.sh --live">
</picture>
